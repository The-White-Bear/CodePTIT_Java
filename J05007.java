...
class NhanVien2 implements Comparable<NhanVien2> {
    ...
    public NhanVien2(String hoTen, String gioiTinh, Date ngaySinh, String diaChi, String maSoThue, Date ngayKyHopDong) {
    ...
    public int compareTo(NhanVien2 o) {
        ...
        else if(this.ngaySinh.before(o.ngaySinh)) return -1;
...
public class J05007 {
    public static void main(String[] args) throws ParseException {
        ...
        List<NhanVien2> danhSachNV = new ArrayList<>();
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        ...
        for (int i = 0; i < n; i++) {
            ...
            danhSachNV.add(new NhanVien2(hoTen, gioiTinh, ngaySinh, diaChi, maSoThue, ngayKyHopDong));
        }
        Collections.sort(danhSachNV);
        for (NhanVien2 nv : danhSachNV) {
